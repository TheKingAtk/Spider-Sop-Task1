...
public class game1v1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game1v1);
    ...
    public void onGame2(View view) {
        ImageView i1 = findViewById(R.id.rock2);
        ImageView i2 = findViewById(R.id.paper2);
        ImageView i3 = findViewById(R.id.scissor2);
    ...
    public void clickHap() {
        CountDownTimer countDownTimer = new CountDownTimer(3000,1000) {
            ...
            public void onFinish() {
                if(firstClick!=2) {
                    Intent intent = new Intent(game1v1.this,game1v1.class);
    ...
    public void check() {
        ...
        if(rounds>1) {
            final Intent intent = new Intent(this,game1v1.class);
            intent.putExtra("p1",p1f);
            intent.putExtra("p2",p2f);
        ...
        {   p1.delete(0,p1.length());
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent main = new Intent(game1v1.this,MainActivity.class);
                    startActivity(main);
                }
            }, 3000);
        }
